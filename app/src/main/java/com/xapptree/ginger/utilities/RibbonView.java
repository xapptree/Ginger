...
public class RibbonView extends View {
    ...
    private void init() {
        ...
        ribbonPaint.setColor(getResources().getColor(R.color.colorAccent));

        textPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        textPaint.setStyle(Paint.Style.FILL);
        textPaint.setFakeBoldText(true);
        textPaint.setTextSize(getResources().getDimension(R.dimen.spaceitem_size));
        textPaint.setTextAlign(Paint.Align.CENTER);
        textPaint.setColor(getResources().getColor(R.color.colorDarkBlue));
    }
